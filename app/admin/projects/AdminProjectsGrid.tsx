          ...
          {filtered.map((project) => {
            ...
            return (
              <div 
                key={project.id} 
                className={cn(
                  "group relative flex flex-col h-full overflow-hidden rounded-2xl border bg-card shadow-sm transition-all hover:shadow-lg",
              ...
              >
                ...
                <div className="absolute top-3 right-3 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <Button 
                    variant="destructive" 
                    size="sm" 
                    className="h-8 px-4 font-bold shadow-xl border border-red-800"
