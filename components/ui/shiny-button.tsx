  ...
  return (
    <>
      <style jsx>{`
        ...
        .shiny-cta {
          --shiny-cta-bg: #0F2A1D; 
          --shiny-cta-bg-subtle: #173D2A; 
          --shiny-cta-fg: #F7F2E7; 
          --shiny-cta-highlight: #C8A45D; 
          --shiny-cta-highlight-subtle: #E8D8B8; 
        ...
        .shiny-cta span { z-index: 1; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; }
      ...
      <button className={cn("shiny-cta inline-flex items-center justify-center rounded-full whitespace-nowrap", className)} onClick={onClick}>
        <span>{children}</span>
      </button>
    </>
  )
