  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none z-10 flex w-full items-center justify-center gap-2">
          {children}
        </div>
        <GlassFilter />
      </Comp>
